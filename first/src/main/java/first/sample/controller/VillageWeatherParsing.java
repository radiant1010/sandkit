    ...
    public static void main(String[] args) {
        try{
           ...
           * */
            ...
            String nx = "56";  //경도
            String ny = "133";   //위도
            String baseDate = "20180523"; // 자신이 조회하고싶은 날짜를 입력해주세요
            String baseTime = "1110"; //자신이 조회하고싶은 시간대를 입력해주세요
            // 서비스 인증키입니다. 공공데이터포털에서 제공해준 인증키를 넣어주시면 됩니다.
            String serviceKey = "TycX%2BmdqH0oNIZuijrmURcyou6MEOZn8L5muFkXGgdfj%2FT76b1Uv7Mm%2FkY5WttsdQSUc6h4rcHEmP3mdo5HMrA%3D%3D";
